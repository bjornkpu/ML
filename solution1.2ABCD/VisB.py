...
# Constants
title = 'Øving 1.2 B - NAND'
W1 = [-9.029834747314453, 9.622445106506348], [-9.029834747314453, 9.622445106506348]
W2 = [[22.835634], [-3.5555675]]
b1 = [[13.277931213378906, -10.621520042419434]]
b2 = [[-8.5754175]]
...
model = models.NAND_visualize(np.mat(W1), np.mat(W2), np.mat(b1), np.mat(b2))
